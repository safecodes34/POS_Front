...
// Hardcode production URL - environment variable not working in Vercel build
const API_BASE_URL = import.meta.env.VITE_API_BASE_URL || 'https://posback-production-2407.up.railway.app/api'
